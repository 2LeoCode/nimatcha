...
var NNI754974728 = {kind: 2, offset: 0, typ: null, name: null, len: 4, sons: {"0": {kind: 1, offset: 0, typ: NTI754974728, name: "wsrsConnecting", len: 0, sons: null}, 
"1": {kind: 1, offset: 1, typ: NTI754974728, name: "wsrsOpen", len: 0, sons: null}, 
"2": {kind: 1, offset: 2, typ: NTI754974728, name: "wsrsClosing", len: 0, sons: null}, 
"3": {kind: 1, offset: 3, typ: NTI754974728, name: "wsrsClosed", len: 0, sons: null}}};
...
function validateUtf8__pureZunicode_u336(s_p0) {
  ...
  BeforeRet: {
    ...
    var i_838861139 = 0;
    F.line = 185;
    var L_838861143 = (s_p0).length;
    Label1: {
      F.line = 186;
        Label2: while (true) {
        if (!(i_838861139 < L_838861143)) break Label2;
          if ((s_p0[chckIndx(i_838861139, 0, (s_p0).length - 1)] <= 127)) {
          F.line = 188;
          i_838861139 = addInt(i_838861139, 1);
          }
          else {
          if (((s_p0[chckIndx(i_838861139, 0, (s_p0).length - 1)] >>> 5) == 6)) {
          if ((s_p0[chckIndx(i_838861139, 0, (s_p0).length - 1)] < 194)) {
          F.line = 190;
          result_838861138 = i_838861139;
          break BeforeRet;
          }
          
          if (((addInt(i_838861139, 1) < L_838861143) && ((s_p0[chckIndx(addInt(i_838861139, 1), 0, (s_p0).length - 1)] >>> 6) == 2))) {
          F.line = 191;
          i_838861139 = addInt(i_838861139, 2);
          }
          else {
            F.line = 192;
            result_838861138 = i_838861139;
          ...
          if (((s_p0[chckIndx(i_838861139, 0, (s_p0).length - 1)] >>> 4) == 14)) {
          if ((((addInt(i_838861139, 2) < L_838861143) && ((s_p0[chckIndx(addInt(i_838861139, 1), 0, (s_p0).length - 1)] >>> 6) == 2)) && ((s_p0[chckIndx(addInt(i_838861139, 2), 0, (s_p0).length - 1)] >>> 6) == 2))) {
          F.line = 195;
          i_838861139 = addInt(i_838861139, 3);
          }
          else {
            F.line = 196;
            result_838861138 = i_838861139;
          ...
          if (((s_p0[chckIndx(i_838861139, 0, (s_p0).length - 1)] >>> 3) == 30)) {
          if (((((addInt(i_838861139, 3) < L_838861143) && ((s_p0[chckIndx(addInt(i_838861139, 1), 0, (s_p0).length - 1)] >>> 6) == 2)) && ((s_p0[chckIndx(addInt(i_838861139, 2), 0, (s_p0).length - 1)] >>> 6) == 2)) && ((s_p0[chckIndx(addInt(i_838861139, 3), 0, (s_p0).length - 1)] >>> 6) == 2))) {
          F.line = 201;
          i_838861139 = addInt(i_838861139, 4);
          }
          else {
            F.line = 202;
            result_838861138 = i_838861139;
  ...
  return result_838861138;

}

function validateUtf8__pureZunicode_u7390(s_p0) {
  var result_838868192 = 0;

  var F = {procname: "unicode.validateUtf8", prev: framePtr, filename: "/root/.choosenim/toolchains/nim-2.2.2/lib/pure/unicode.nim", line: 0};
  framePtr = F;
    F.line = 1199;
    F.filename = "unicode.nim";
    result_838868192 = validateUtf8__pureZunicode_u336((s_p0.slice(0, (s_p0).length - 1 + 1)));
  framePtr = F.prev;

  return result_838868192;

}

function nucruneLen(s_p0) {
  var result_838860829 = 0;
  ...
  framePtr = F;
    ...
    Label1: {
      F.line = 54;
        Label2: while (true) {
        if (!(i_838860830 < (s_p0).length)) break Label2;
          if ((s_p0[chckIndx(i_838860830, 0, (s_p0).length - 1)] <= 127)) {
          F.line = 55;
          i_838860830 = addInt(i_838860830, 1);
          }
          else {
          if (((s_p0[chckIndx(i_838860830, 0, (s_p0).length - 1)] >>> 5) == 6)) {
          F.line = 56;
          i_838860830 = addInt(i_838860830, 2);
          }
          else {
          if (((s_p0[chckIndx(i_838860830, 0, (s_p0).length - 1)] >>> 4) == 14)) {
          F.line = 57;
          i_838860830 = addInt(i_838860830, 3);
          }
          else {
          if (((s_p0[chckIndx(i_838860830, 0, (s_p0).length - 1)] >>> 3) == 30)) {
          F.line = 58;
          i_838860830 = addInt(i_838860830, 4);
          }
          else {
          if (((s_p0[chckIndx(i_838860830, 0, (s_p0).length - 1)] >>> 2) == 62)) {
          F.line = 59;
          i_838860830 = addInt(i_838860830, 5);
          }
          else {
          if (((s_p0[chckIndx(i_838860830, 0, (s_p0).length - 1)] >>> 1) == 126)) {
          F.line = 60;
          i_838860830 = addInt(i_838860830, 6);
          }
          else {
            F.line = 61;
          i_838860830 = addInt(i_838860830, 1);
          ...
          F.line = 62;
          result_838860829 = addInt(result_838860829, 1);
        }
    };
  framePtr = F.prev;

  return result_838860829;

}

function runeLen__pureZunicode_u7218(s_p0) {
  var result_838868020 = 0;

  var F = {procname: "unicode.runeLen", prev: framePtr, filename: "/root/.choosenim/toolchains/nim-2.2.2/lib/pure/unicode.nim", line: 0};
  framePtr = F;
    F.line = 1166;
    F.filename = "unicode.nim";
    result_838868020 = nucruneLen((s_p0.slice(0, (s_p0).length - 1 + 1)));
  framePtr = F.prev;

  return result_838868020;
...
function nsuRepeatChar(c_p0, count_p1) {
  ...
  framePtr = F;
    ...
    result_889193571 = nimCopy(null, mnewString(count_p1), NTI33554449);
    Label1: {
      F.line = 1351;
      var i_889193576 = 0;
      F.line = 81;
      ...
      Label2: {
        F.line = 97;
          ...
          if (!(res_553648261 <= colontmp__553648260)) break Label3;
            F.line = 1351;
            F.filename = "strutils.nim";
            i_889193576 = res_553648261;
            F.line = 1351;
            result_889193571[chckIndx(i_889193576, 0, (result_889193571).length - 1)] = c_p0;
            F.line = 102;
            F.filename = "iterators_1.nim";
...
function alignString__pureZstrformat_u20(s_p0, minimumWidth_p1, align_p2, fill_p3) {
  ...
  framePtr = F;
    ...
    result_788529177 = nimCopy(null, s_p0, NTI33554449);
    }
    else {
      F.line = 346;
      ...
      var sRuneLen_788529178 = Temporary1;
      F.line = 347;
      var toFill_788529179 = subInt(minimumWidth_p1, sRuneLen_788529178);
      if ((toFill_788529179 <= 0)) {
      F.line = 349;
      result_788529177 = nimCopy(null, s_p0, NTI33554449);
      }
      else {
      ...
      F.line = 351;
      result_788529177 = nimCopy(null, (s_p0).concat(nsuRepeatChar(fill_p3, chckRange(toFill_788529179, 0, 2147483647))), NTI33554449);
      }
      else {
      if ((align_p2 == 94)) {
      F.line = 353;
      var half_788529180 = divInt(toFill_788529179, 2);
      F.line = 354;
      result_788529177 = nimCopy(null, (nsuRepeatChar(fill_p3, chckRange(half_788529180, 0, 2147483647))).concat(s_p0,nsuRepeatChar(fill_p3, chckRange(subInt(toFill_788529179, half_788529180), 0, 2147483647))), NTI33554449);
      }
      else {
        F.line = 356;
        result_788529177 = nimCopy(null, (nsuRepeatChar(fill_p3, chckRange(toFill_788529179, 0, 2147483647))).concat(s_p0), NTI33554449);
      }
      }}
    }
...
function formatValue__main_u43(result_p0, result_p0_Idx, value_p1) {
  ...
  framePtr = F;
    F.line = 633;
    F.filename = "strformat.nim";
    formatValue__main_u52(result_p0, result_p0_Idx, reprEnum(value_p1, NTI754974728));
  framePtr = F.prev;
...
function readyState__jsZweb95socketZweb95socket_u48(socket_p0) {
  ...
  framePtr = F;
    ...
    result_754974770 = chckRange(socket_p0.readyStateRaw, 0, 3);
  framePtr = F.prev;

  return result_754974770;
